...
public record ProductDto(
    ...
    string ListImage, int V2RayCategoryId, int WireGuardCategoryId);
...
public record ProductInput(
    ...
    int? V2RayCategoryId, int? WireGuardCategoryId = null);
...
public static class Mapping
{
    ...
    public static ProductDto ToDto(this Product p, string categoryName) =>
        new(p.Id, p.Name, p.CategoryId, categoryName, p.Price, p.DiscountPercent, p.FinalPrice,
            ...
            p.DeliveryTemplate, p.ListImage, p.V2RayCategoryId, p.WireGuardCategoryId);
