...
export default async function MaintenancePage() {
  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden bg-[#0b0b12] px-6 text-center text-white">
      ...
      <div className="relative z-10 w-full max-w-xl">
        <div className="mb-8 flex items-center justify-center gap-2.5">
          ...
          <span className="font-bigshot text-lg leading-[1.05] text-white">
        ...
        <div className="mx-auto mb-8 grid h-24 w-24 place-items-center rounded-3xl border border-white/10 bg-white/5">
        ...
        <h1 className="text-3xl font-bold text-white sm:text-4xl">{adv.maintenanceTitle}</h1>
        <p className="mx-auto mt-5 max-w-md text-sm leading-8 text-white/65">{adv.maintenanceMessage}</p>

        <div className="mt-8 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-5 py-2.5 text-sm font-medium text-white/70">
        ...
        {content.footer.socials.length > 0 && (
          <div className="mt-10 flex items-center justify-center gap-6 text-white/55">
            {content.footer.socials.map((s) => (
              <a key={s.label} href={s.href} className="text-sm font-medium transition hover:text-white">
                {s.label}
              </a>
            ))}
          </div>
