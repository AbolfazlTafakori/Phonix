...
export default async function BlogPage() {
  ...
  return (
    <div className="mx-auto max-w-[1320px] px-5 pb-20 pt-10">
      <div className="relative mb-10 overflow-hidden rounded-3xl border border-[var(--hl-border)] bg-gradient-to-l from-[var(--hl-red)]/12 via-[var(--hl-orange)]/8 to-transparent px-8 py-12">
