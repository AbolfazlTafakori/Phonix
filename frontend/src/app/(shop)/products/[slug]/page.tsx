    ...
    <div className="mx-auto max-w-[1840px] px-4 pb-16 pt-6 sm:px-6 lg:px-8 xl:px-16">
      ...
      <div className="grid items-start gap-5 sm:gap-6 lg:grid-cols-[minmax(300px,380px)_1fr_minmax(300px,360px)]">
        ...
        {/* The buying column — desktop only; the sticky bottom bar carries the price and CTA on mobile.
            BuyBox matches its own height to the gallery (not the plan picker, which can run much taller
            with many plans) via a measured min-height — see useSyncGalleryHeight/useGalleryHeight. */}
