...
const CONFIRM_IMAGE = "/figma/auth-reset.webp";
    ...
    <AuthShell image={CONFIRM_IMAGE}>
      ...
      {state === "ok" && (
        <div className="py-6 text-center">
          ...
          <h1 className="text-[18px] font-extrabold text-[var(--chat-ink)]">ایمیل جدید تأیید شد</h1>
          <p className="mt-2 text-[13px] leading-7 text-[var(--chat-ink-2)]">ایمیل حساب شما با موفقیت به نشانی جدید تغییر کرد.</p>
      ...
      {state === "error" && (
        <div className="py-6 text-center">
          ...
          <p className="mt-2 text-[13px] leading-7 text-[var(--chat-ink-2)]">لینک تأیید نامعتبر یا منقضی شده است. از حساب کاربری خود دوباره درخواست تغییر ایمیل بزنید.</p>
