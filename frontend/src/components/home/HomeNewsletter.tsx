    ...
    <section className="mx-auto max-w-[1840px] px-4 sm:px-8 xl:px-16 py-10">
      ...
      >
        ...
        <div className="hidden shrink-0 items-center gap-2.5 border-l border-white/25 pl-6 text-white xl:flex">
          ...
          <img loading="lazy" decoding="async" src="/figma/logo-phoenix.webp" alt="Phoenix Verify" className="h-12 w-auto" />
        </div>
        ...
        <form className="flex flex-1 flex-col items-stretch gap-3 sm:flex-row sm:items-center">
          ...
          />
          <button type="submit" style={{ background: "#fff" }} className="h-12 shrink-0 rounded-xl px-6 text-[14px] font-bold text-[#c8102e] transition hover:brightness-95">
            عضویت در خبرنامه
          </button>
        </form>
