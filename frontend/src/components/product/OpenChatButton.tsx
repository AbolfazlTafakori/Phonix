...
export default function OpenChatButton() {
  return (
    <button
      ...
      className="mt-2.5 flex h-11 w-full items-center justify-center rounded-xl border bg-[var(--ac-panel-bg)] text-[13px] font-bold transition hover:bg-[color:var(--ac-menu-hover)]"
