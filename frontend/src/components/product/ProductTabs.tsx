...
export function TrustItem({ icon, title, desc }: { icon: ReactNode; title: string; desc: string }) {
  return (
    <div className="flex flex-col items-center gap-2 px-4 py-5 text-center">
      <span className="grid h-11 w-11 place-items-center rounded-full" style={{ background: "var(--ac-stat-icon-orange-bg)", color: "#F2551F" }}>{icon}</span>
      <p className="text-[13px] font-black" style={{ color: "var(--ac-title)" }}>{title}</p>
